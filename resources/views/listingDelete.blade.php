...
<p> <?php $i = 0; $resultsArray=array(); $g=0;
...
{{ Form::open(array('action'=> array('panelAccess@deleteListingsNow')))}}

Listing ids that need to be deleted(seperate listings by commas) {!! Form::text('ListingIds') !!}
